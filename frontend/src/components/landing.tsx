        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <Button
              onClick={async () => {
                alert(
                  "🚧 Service temporarily discontinued due to cloud costs. We will be back soon"
                );
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <Input
                ...
                readOnly
                type="url"
                value={`http://${uploadId}.127.0.0.1.nip.io:3005`}
              />
            </div>
            <br />
            <Button
              onClick={async () => {
                alert(
                  "🚧 Service temporarily discontinued due to cloud costs."
                );
                return; // prevent deployment logic from running
              }}
              disabled={uploadId !== "" || uploading}
